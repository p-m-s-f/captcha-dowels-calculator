...
<figure style="margins: auto">
    <img src="https://storage.homestuck.com/story/homestuck/media/images/panels/act-1/00010.gif"
         alt="Panel from Homestuck page 001910. John Egbert expresses frustration at being unable to access the fake arms in his inventory. The fake arms are stored on a card 'beneat' the card containing his smoke pellets.">
<figcaption>
    Unfortunately, you cannot access the FAKE ARMS! Their card is underneath the one you just used to captchalogue the SMOKE PELLETS. You will have to use the pellets first in order to access the arms... Your SYLLADEX'S FETCH MODUS is currently dictated by the logic of a STACK DATA STRUCTURE. You were never all that great with data structures and you find the concept puzzling and mildly irritating.</figcaption>
</figure>
